...
readEachLineSync('lex.csv', (line) => {
  ...
  // type = arr[6];
  yomi = arr[11];
  if (pos1 != '名詞') { return true; }
  if (pos2 == '固有名詞') { return true; }
  // if (type == '地域') { return true; }
  // if (type == '人名') { return true; }
  // if (type == '組織') { return true; }
...
idioms = arr.reduce(function(map, obj) {
